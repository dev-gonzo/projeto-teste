  ...
  describe('Getters', () => {
    describe('selectId', () => {
      ...
      it('should handle empty label', () => {
        component.id = undefined;
        component.label = '';
        expect(component.selectId).toBe('multi-select-');
      });
    });
  ...
  describe('Template Integration', () => {
    ...
    describe('Selected Options Display', () => {
       it('should display selected options as chips', () => {
         ...
         const chips = fixture.debugElement.queryAll(By.css('.selected-chip.visible'));
       ...
       it('should show remove button for each selected option', () => {
         ...
         const selectedChips = fixture.debugElement.queryAll(By.css('.selected-chip.visible'));
         const removeButtons = fixture.debugElement.queryAll(By.css('.selected-chip.visible .chip-remove'));
       ...
       it('should call removeSelectedOption when remove button clicked', () => {
         ...
         const removeButton = fixture.debugElement.query(By.css('.chip-remove'));
    ...
    describe('Options List', () => {
      ...
      it('should show checkboxes for options', () => {
      ...
      it('should check selected options', () => {
        ...
        expect(checkboxes[2].nativeElement.checked).toBeFalse();
      });
    ...
    describe('CSS Classes', () => {
       it('should apply is-invalid class when control has error', () => {
         ...
         const container = fixture.debugElement.query(By.css('.custom-multi-select'));
         expect(container.nativeElement.classList).toContain('is-invalid');
       });
       ...
       it('should not apply is-invalid class when control is valid', () => {
         ...
         const container = fixture.debugElement.query(By.css('.custom-multi-select'));
         expect(container.nativeElement.classList).not.toContain('is-invalid');
       });
       ...
       it('should apply show class when dropdown is open', () => {
         ...
         const container = fixture.debugElement.query(By.css('.custom-multi-select'));
         expect(container.nativeElement.classList).toContain('show');
       });
       ...
       it('should not apply show class when dropdown is closed', () => {
         ...
         const container = fixture.debugElement.query(By.css('.custom-multi-select'));
         expect(container.nativeElement.classList).not.toContain('show');
       });
       ...
       it('should apply text-muted class when no options selected and no error', () => {
         ...
         const container = fixture.debugElement.query(By.css('.custom-multi-select'));
         if (container) {
           expect(container.nativeElement.classList).toContain('text-muted');
         } else {
    ...
    describe('Accessibility', () => {
       it('should have proper aria attributes', () => {
         ...
         if (container && container.nativeElement.getAttribute('role')) {
           expect(container.nativeElement.getAttribute('role')).toBe('combobox');
       ...
       it('should update aria-expanded when dropdown opens', () => {
         ...
         if (container && container.nativeElement.getAttribute('aria-expanded')) {
           expect(container.nativeElement.getAttribute('aria-expanded')).toBe('true');
       ...
       it('should have proper id attributes', () => {
         ...
         const container = fixture.debugElement.query(By.css('.custom-multi-select'));
         expect(container.nativeElement.id).toBe('test-multi-select');
       });
     });
   });
 });